...
Album: Write a function called make_album() that builds a Object describing a music album.
 ...
 to make_album() that allows you to store the number of tracks on an album. If
 the calling line includes a value for the number of tracks, add that value to the
...
const album2 = make_album('Artist2', 'Album Title2', 12); // Including number of tracks
